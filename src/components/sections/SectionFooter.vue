<template>
    <div>
        ...
        <footer class="bg-gray-200 dark:bg-[#303032] dark:text-white">
                ...
                <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div>
                        ...
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="#" class=" hover:underline hover:text-blue-500 transition-all">About</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Careers</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Brand Center</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Blog</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Discord
                                    Server</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Twitter</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Facebook</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Privacy
                                    Policy</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Licensing</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Terms &amp;
                                    Conditions</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-body font-medium">
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">iOS</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Android</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">Windows</a>
                            </li>
                            <li class="mb-4">
                                <a href="#" class="hover:underline hover:text-blue-500 transition-all">MacOS</a>
                            </li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="px-14 py-6 bg-gray-300 dark:bg-[#28282a] md:flex md:items-center md:justify-between">
